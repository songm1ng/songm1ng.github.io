...
<head>
	<title>站长推荐内容列表 - <%=SiteTitle%></title>
...
<!-- 一个循环段落开始 -->
		...
		<div>
		<span class="mbg3">
		<span class="title">您现在的位置：<a href="Index.asp">首页</a> >> 按时间排序更新文章 >> 列表</span>
...
mypage.getconn=conn
mypage.getsql="select ID,Title,DateAndTime,Hits,dig,IsTop,Images,TitleFontColor,Content from pcook_Article Where yn=0 and IsHot = 1 order by IsTop desc,ID desc"
